...
execute as @e[name="verstak naaborot"] run execute at @s run tellraw @a[distance=..4.5] {"text":"Для крафта надо ставить рычаг по бокам или снизу. Дальше кидаем предмет и нажимаем на один из рычагов. Готово!"}
